...
const server = http.createServer((req, res) => {
  ...
  if (req.method === 'GET' && req.url === '/ready') {
    try {
      ...
      return send(res, 503, { status: 'not_ready', reason: error.message, requestId: rid }, rid);
    }
  }

  // All intelligence routes remain intentionally unavailable until authentication,
...
export { server, requireProductionConfiguration };
